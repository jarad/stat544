...
qplot(iteration, value, data=r[r$iteration>200,])+facet_wrap(~parameter, scales="free")
@
...
mj$mcmc ="jags"
r$mcmc = "mine"
ggplot(rbind(r[,-1],mj[,-1]), aes(x=value, col=mcmc))+geom_density()+facet_wrap(~parameter, scales="free")
@
